...
void alertWebService() {
  if(unHealthCount >= 3){
    ...
    String url="https://sc.ftqq.com/SCU89410Tb6a77834c5c648318b0eea0e362f80bf5e6caedaaeb28.send?text=ESP-Service-Check-Alert&desp=18join.com-From-"+String(buffer);
